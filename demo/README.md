...
The demo uses the real firmware HTML/CSS/JavaScript, plus mocked device API responses. Preview buttons update the small local output swatch instead of sending data to LEDs.
